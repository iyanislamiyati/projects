...
int main(int argc, char *argv[])
{
	...
	//Save
	if((outdata = fopen("fungsi-partisi-dpi-12.dat","w")) == NULL){
		fprintf(stderr," Cannot open file fungsi-partisi-dpi-12.dat\n");
		exit(3);
	}
	for(i = 1; i <= NT; i++){
	...
	if((outdata = fopen("entropi-dpi-12.dat","w")) == NULL){
		fprintf(stderr," Cannot open file entropi-dpi-12.dat\n");
		exit(3);
	}
	for(i = 1; i <= NT; i++){
	...
	if((outdata = fopen("energi-bebas-dpi-12.dat","w")) == NULL){
		fprintf(stderr," Cannot open file energi-bebas-dpi-12.dat\n");
		exit(3);
	}
	for(i = 1; i <= NT; i++){
	...
	if((outdata = fopen("energi-dalam-dpi-12.dat","w")) == NULL){
		fprintf(stderr," Cannot open file energi-dalam-dpi-12.dat\n");
		exit(3);
	}
	for(i = 1; i <= NT; i++){
	...
	if((outdata = fopen("density-matrix-dpi.dat","w")) == NULL){
		fprintf(stderr," Cannot open file density-matrix-dpi.dat\n");
		exit(3);  
	}
	for(i = 1; i <= NX; i++){
		for(j = 1; j <= NX; j++){
	...
	if((outdata = fopen("densitas-dpi-12.dat","w")) == NULL){
		fprintf(stderr," Cannot open file densitas-dpi-12.dat\n");
		exit(3);
	}
